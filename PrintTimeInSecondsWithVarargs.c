function print TimeInSeconds with Varargs
...
- Time complexity: O(n), where n is the total number of Time objects processed across all function calls.
- Space complexity: O(1), as only a fixed amount of memory is used regardless of input size.
